...
- [Требования Веб приложения](Part.IIII.Diplom/Task.I-Web/requirements_web_app_1.1.pdf)
- [Макет Веб приложения](Part.IIII.Diplom/Task.I-Web/design-web.pdf "Sorry! This PDF may not be available for preview, but you could download it. The design was uploaded from the Figma website.")
- [Требования Мобильного приложения для курьеров](Part.IIII.Diplom/Task.II-Mobile/Requirements_mob_app.pdf)
- [Макет Мобильного приложения для курьеров](Part.IIII.Diplom/Task.II-Mobile/design-mobile.pdf "Sorry! This PDF may not be available for preview, but you could download it. The design was uploaded from the Figma website.")
- [Требования к бэкенду приложения](Part.IIII.Diplom/Task.III-API/requirements_backend.pdf)
...
> [!TIP]
> Не забудь написать кейсы и на вёрстку по макетам к этой функциональности

> [!NOTE]
> Мобильное тестирование можно прововодить на любом устройстве Android выше 9 версии или эмуляторе.
...
В ходе работы были изучены требования для веб-приложения, мобильного приложения для курьеров и бэкенда для приложения Я.Самокат.
Спроектированы проверки и проведено тестирование согласно поставленой задачи.

Общее время выполнения задач с учетом их доработки после ревью не превысило 3-х недель. 

Первое задание — 9 р.д., Второе задание — 3 р.д., Третье задание — 4 р.д. + 2 р.д — доработки.

Проверки и баги представлены в рабочей таблице ниже по ссылке:

**[Рабочая таблица](Part.IIII.Diplom/DP_print_preview_ver.pdf "Можно скачать в формате XLSX - Part.IIII.Diplom/Рабочая_таблица_Диплом_рев2.xlsx =)")**
